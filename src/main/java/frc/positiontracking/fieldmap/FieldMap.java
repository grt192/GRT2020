...
public class FieldMap {
        ...
        private static final double ROBOT_WIDTH = 50;
        ...
        private static void buildMap() {
                ...
                Polygon RightCornerNear = new Polygon(new Vector(0, 253.531), new Vector(0, FIELD_WIDTH),
                                new Vector(25.715, FIELD_WIDTH));
                Polygon LeftCornerFar = new Polygon(new Vector(FIELD_HEIGHT, 0), new Vector(604.18, 0),
                                new Vector(FIELD_HEIGHT, 70.655));
                Polygon RightCornerFar = new Polygon(new Vector(FIELD_HEIGHT, 253.531),
                                new Vector(FIELD_HEIGHT, FIELD_WIDTH), new Vector(603.545, FIELD_WIDTH));
                ...
                obstacles[6] = BlueTrench;

                obstacles[7] = RendezvousZoneFar;
                obstacles[8] = RendezvousOurTrench;
                obstacles[9] = RendezvousTheirTrench;
                ...
                Polygon SafeTrench = new Polygon(new Vector(206.630, 267.811), new Vector(206.345, FIELD_WIDTH),
                                new Vector(422.63, FIELD_WIDTH), new Vector(422.63, 267.811));
