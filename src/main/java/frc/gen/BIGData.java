...
public class BIGData {
	...
	private static SwerveData swerveData;
	...
	public static void setSwerveData(SwerveData data) {
		put("enc_vx", data.enc_vx);
		put("enc_vy", data.enc_vy);
		put("enc_w", data.enc_w);
	}

	public static void setEstPos(double x, double y) {
		put("est_x", x);
		put("est_y", y);
	}

	public static void setNavXPosition(double x, double y) {
		put("navx_x", x);
		put("navx_y", y);
	}
